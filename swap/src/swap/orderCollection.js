...
class OrderCollection extends Collection {
  ...
  _saveMyOrders() {
    ...
    console.log ('after save: -----------------------------', localStorage.getItem('myOrders' ) )
  ...
  getBuyCurrencyOrders(buyCurrency) {
    return this.items.filter((item) => buyCurrency === item.buyCurrency)
  }
  
  getCellCurrencyOrders(cellCurrency) {
    return this.items.filter((item) => cellCurrency === item.cellCurrency)
  }
